...
const revText = [
            ...
            'Не знала что подарить другу не день рождения и случайно наткнулась на "bookfrom.me". Процесс создания книги и предосмотр не могут не радовать! Так же порадовала быстрая доставка.',
  ...
  render () {
    ...
    return (
        <div styleName="r" className="flex">
          ...
          <div onClick={()=>this.props.actions.openRouteModal('addReview')} styleName="add-review">
            Оставить отзыв  
          </div>
        </div>
    )
