...
class Intro extends Component {
    setStyle = image_url => {
        if (image_url.match("v1")) return ["name-v1", "sender-v1",'wish-text-v1'];
        else if (image_url.match("v2")) return ["name-v2", "sender-v2", 'wish-text-v2'];
        else if (image_url.match("v3")) return ["name-v3", "sender-v3", 'wish-text-v3'];
        else if (image_url.match("v4")) return ["name-v4", "sender-v4", 'wish-text-v4'];
